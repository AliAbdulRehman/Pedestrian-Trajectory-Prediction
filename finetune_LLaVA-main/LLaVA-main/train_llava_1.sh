...
srun singularity_wrapper exec deepspeed llava/train/train_mem.py \
    ...
    --version ped1 \
    --data_path ./playground/data/overall_train_prompts_fm.json \
    --validation_data_path ./playground/data/overall_val_prompts_fm.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints0/llava-v1.5-7b-task-lora \
    --num_train_epochs 50 \
